...
export const en: Dictionary = {
  ...
  galeria: {
    ...
    pageTitle: "Gallery",
    pageSubtitle:
      "Take a look at the office, the patient-care spaces, and the details we craft for every childhood.",
    filters: {
      todas: "All photos",
      consultorio: "Office",
      procedimientos: "Procedures",
      nutricion: "Nutrition",
      pacientes: "Happy patients",
    },
  ...
  contacto: {
    title: "Let's talk about your child's digestive health",
    subtitle:
    ...
    messagePlaceholder:
      "Share your questions or the reason for the consult. We're here to support your child.",
    helper: "We will contact you as soon as possible",
    send: "Send message",
    sending: "Sending…",
    success: "Message sent!",
    successDesc: "We'll get in touch soon.",
    ...
    whatsappPrompt: "Need a quick answer? Message us on WhatsApp.",
  ...
  footer: {
    ...
    contact: {
      ...
      address: "Av. Escazú, Medical Tower, 4th floor, Escazú, San José, Costa Rica",
    },
    hours: {
      titulo: "Hours",
      items: [
  ...
  booking: {
    ...
    pasos: ["Service", "Details", "Date & time", "Confirm"],
    pasosMenor: [
      "Service",
      "Guardian details",
      "Patient details",
    ...
    preguntaMayorTitulo: "Is the patient an adult (+18 years old)?",
    preguntaMayorAyuda:
      "This helps us collect the right details for the consult.",
    siMayor: "Yes, they are an adult",
    noMenor: "No, they are a minor",
    cambiarRespuesta: "Change answer",
    respuestaMayor: "Adult patient",
    respuestaMenor: "Minor patient",
