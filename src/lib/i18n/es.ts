...
export const es: Dictionary = {
  ...
  galeria: {
    ...
    pageTitle: "Galería",
    pageSubtitle:
      "Conoce el consultorio, los espacios de atención y los detalles que cuidamos para cada infancia.",
    filters: {
      todas: "Todas las fotos",
      consultorio: "Consultorio",
      procedimientos: "Procedimientos",
      nutricion: "Nutrición",
      pacientes: "Pacientes felices",
    },
  ...
  contacto: {
    title: "Hablemos sobre la salud digestiva de tu hijo",
    subtitle:
    ...
    messagePlaceholder:
      "Cuéntanos las dudas o el motivo de consulta. Estamos aquí para acompañar a tu hijo.",
    helper: "Te contactaremos lo antes posible",
    send: "Enviar mensaje",
    sending: "Enviando…",
    ...
    whatsappPrompt: "¿Necesitas una respuesta rápida? Escríbenos por WhatsApp.",
  ...
  booking: {
    ...
    pasos: ["Servicio", "Datos", "Fecha y hora", "Confirmar"],
    pasosMenor: [
      "Servicio",
      "Datos del tutor",
      "Datos del paciente",
    ...
    preguntaMayorTitulo: "¿El paciente es mayor de edad (+18 años)?",
    preguntaMayorAyuda:
      "Esto nos ayuda a recolectar los datos correctos para la consulta.",
    siMayor: "Sí, es mayor de edad",
    noMenor: "No, es menor de edad",
    cambiarRespuesta: "Cambiar respuesta",
    respuestaMayor: "Paciente mayor de edad",
    respuestaMenor: "Paciente menor de edad",
